...
function! s:DefinePlugMaps() abort
    ...
    call s:SetNoremap(['n'], '<plug>(table_move_row_up)',       '<cmd>call table#MoveRow("up")<cr>')
    call s:SetNoremap(['n'], '<plug>(table_move_row_down)',     '<cmd>call table#MoveRow("down")<cr>')
    call s:SetNoremap(['n'], '<plug>(table_move_column_left)',  '<cmd>call table#MoveColumn("left")<cr>')
    call s:SetNoremap(['n'], '<plug>(table_move_column_right)', '<cmd>call table#MoveColumn("right")<cr>')
